class Game {
    ...
    update() {
        ...
        for (let c = 0; c < width; c++) {
            ...
            currTile.classList.remove("shakeanimation");
        ...
        if (!guessList.includes(guess)) {
            ...
            for (let c = 0; c < width; c++) {
                let currTile = document.getElementById(this.row.toString() + '-' + c.toString());
                currTile.classList.add("shakeanimation");
            }    
            return;
        }
        ...
        for (let c = 0; c < width; c++) {
            let currTile = document.getElementById(this.row.toString() + '-' + c.toString());
            currTile.classList.add("flipanimation");
            let letter = currTile.innerText;
    ...
    wordNotFoundPopup(){
        ...
        wordNotFoundPopup.innerText = "not in wordlist";
        setTimeout(function(){
